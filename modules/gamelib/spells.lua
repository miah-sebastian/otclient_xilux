SpelllistSettings = {
    ['Default'] = {
		...
		spellOrder = {'Animate Dead Rune','Annihilation','Apprentices Strike','Arrow Call','Avalanche Rune',
					  'Berserk','Berserk Multikey','Blank Rune','Blood Rage','Bruise Bane','Brutal Strike',
					  'Brutal Strike Multikey','Buzz','Cancel Invisibility','Cancel Magic Shield','Challenge','Chameleon Rune',
					  'Charge','Chill Out','Chivalrous Challenge','Conjure Arrow','Conjure Bolt','Conjure Diamond Arrow',
					  'Conjure Enchanted Staff','Conjure Explosive Arrow','Conjure Piercing Bolt','Conjure Poisoned Arrow','Conjure Power Bolt','Conjure Royal Star',
					  'Conjure Sniper Arrow','Conjure Spectral Bolt','Conjure Wand of Darkness','Convince Creature Rune','Creature Illusion','Cure Bleeding',
					  'Cure Burning','Cure Curse','Cure Electrification','Cure Poison','Cure Poison Rune','Curse',
					  'Death Strike','Destroy Field Rune','Disintegrate Rune','Divine Caldera','Divine Dazzle','Divine Healing',
					  'Divine Missile','Druid familiar','Electrify','Enchant Party','Enchant Spear','Energy Beam',
					  'Energy Bomb Rune','Energy Field Rune','Energy Strike','Energy Strike Multikey','Energy Wall Rune','Energy Wave',
					  'Envenom','Eternal Winter','Ethereal Spear','Ethereal Spear Multikey','Explosion Rune','Expose Weakness',
					  'Fair Wound Cleansing','Fierce Berserk','Find Person','Fire Bomb Rune','Fire Field Rune','Fire Wall Rune',
					  'Fire Wave','Fire Wave Multikey','Fireball Rune','Flame Strike','Flame Strike Multikey','Food',
					  'Front Sweep','Great Energy Beam','Great Fire Wave','Great Fireball Rune','Great Light','Groundshaker',
					  'Haste','Heal Friend','Heal Lowest Party Member','Heal Party','Heavy Magic Missile Rune','Hells Core',
					  'Holy Flash','Holy Missile Rune','Ice Strike','Ice Strike Multikey','Ice Wave','Ice Wave Multikey',
					  'Icicle Rune','Ignite','Inflict Wound','Intense Healing','Intense Healing Rune','Intense Recovery',
					  'Intense Wound Cleansing','Invisibility','Knight familiar','Levitate','Light','Light Healing',
					  'Light Magic Missile Rune','Light Stone Shower Rune','Lightest Magic Missile','Lightest Missile Rune','Lightning','Magic Patch',
					  'Magic Rope','Magic Shield','Magic Wall Rune','Mana Train','Mass Healing','Mud Attack',
					  'Natures Embrace','Paladin familiar','Paralyze Rune','Physical Strike','Poison Bomb Rune','Poison Field Rune',
					  'Poison Wall Rune','Practice Healing','Practise Fire Wave','Protect Party','Protector','Rage of the Skies',
					  'Recovery','Restoration','Salvation','Sap Strength','Scorch','Sharpshooter',
					  'Sorcerer familiar','Soulfire Rune','Stalagmite Rune','Stone Shower Rune','Strong Energy Strike','Strong Ethereal Spear',
					  'Strong Flame Strike','Strong Haste','Strong Ice Strike','Strong Ice Wave','Strong Terra Strike','Sudden Death Rune',
					  'Summon Creature','Swift Foot','Terra Strike','Terra Strike Multikey','Terra Wave','Thunderstorm Rune',
					  'Train Party','Ultimate Energy Strike','Ultimate Flame Strike','Ultimate Healing','Ultimate Healing Rune','Ultimate Ice Strike',
					  'Ultimate Light','Ultimate Terra Strike','Whirlwind Throw','Wild Growth Rune','Wound Cleansing','Wrath of Nature'}
    } --[[,
  ['Custom'] =  {
...
SpellInfo = {
	['Default'] = {
		...
		['Terra Strike Multikey'] = {
			id = 213,
			words = 'exori tera mk',
			exhaustion = 2000,
			premium = true,
			type = 'Instant',
			icon = 'terrastrikemultikey',
			mana = 0,
			level = 90,
			soul = 0,
			group = {
